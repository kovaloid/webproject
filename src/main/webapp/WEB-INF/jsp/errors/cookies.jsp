...
<head>
    ...
    <fmt:message bundle="${loc}" key="local.subtitle.cookies_fail" var="cookies_fail_subtitle"/>
    <fmt:message bundle="${loc}" key="local.error.text" var="error_text"/>
    <fmt:message bundle="${loc}" key="local.error.cookies.message_text" var="message_text"/>
    <fmt:message bundle="${loc}" key="local.button.back" var="back_button"/>

    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta name="author" content="Artem Kovalev"/>
    <title>${cookies_fail_subtitle} - ${page_title}</title>
